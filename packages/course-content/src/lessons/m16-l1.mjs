/** Lesson body: m16.l1 — reversing the sensor statically (markdown). */
export default `## Read the sensor without running it

Dynamic analysis tripped alarms in m12; static analysis never executes a
...
2. Submit the registered process-callback VA you found in m12
