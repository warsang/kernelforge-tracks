...
| DPC/timer queueing | partial | native | n/a | queued/pending model (no deferred invocation yet) |
...
KeRaiseIrql/LowerIrql, KeInitializeDpc, KeInsertQueueDpc, KeInitializeTimer,
KeSetTimer/CancelTimer, KeQueryTickCount/SystemTime, KeStallExecutionProcessor,
...
1. Deferred procedure *invocation* (queued DPCs currently pend).
